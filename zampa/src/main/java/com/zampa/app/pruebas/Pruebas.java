...
public class Pruebas implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		/* RECETAS */
		recetaRepository.save(Receta.builder().nombre("Bizcocho de limón").descripcion("Se cogen dos huevos...").dificultad(facil).build());	
		recetaRepository.save(Receta.builder().nombre("Paella").descripcion("Un vaso de arroz...").dificultad(dificil).build());
		recetaRepository.save(Receta.builder().nombre("Tortilla").descripcion("Se cogen dos huevos...").dificultad(facil).build());
		recetaRepository.save(Receta.builder().nombre("Pollo").descripcion("KFC momento").dificultad(facil).build());	
		recetaRepository.save(Receta.builder().nombre("Yogur de frambuesa").descripcion("Leche?").dificultad(normal).build());
		recetaRepository.save(Receta.builder().nombre("Sopa").descripcion("Sopa de pollo patrocionada por Mercadona").dificultad(normal).build());
